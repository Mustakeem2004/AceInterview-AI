    ...
    <div className='bg-[#f3f3f3] flex justify-center  px-4 pt-6'>
        ...
        <div className='flex items-center gap-6 relative'>
            <div className='relative'>
                 ...
                 {showCreditPopup && (
                  <div className='absolute -right-15  mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
            ...
            <div className='relative'>
                 ...
                 {showUserPopup && (
                  <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                     ...
                     <button onClick={handleLogout} className='w-full text-left text-sm py-2 hover:text-black flex items-center gap-2 text-red-500'>
