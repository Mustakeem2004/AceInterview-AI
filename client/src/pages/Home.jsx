      ...
      <div className="flex-1 px-6 py-20">
        ...
        <div className="text-center mb-28">
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-semibold max-w-4xl leading-tight mx-auto"
          >
          ...
          <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ duration: 0.6 }}
            className="text-center mt-6 text-gray-500 text-lg  max-w-2xl mx-auto"
          >
            Role based smart interviews with smart follow-ups, adaptive
